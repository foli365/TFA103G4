...
<head>
  <title>Document</title>
    ...
    <link rel="stylesheet" href="productstyle/member.css">
</head>
...
<body>
        ...
        <nav class="sidebar">
            ...
            <ul>
                <li>
                    ...
                    <ul class="feat-show">
                        <li><a href="" class="member_list">會員資料表</a></li>
                    </ul>
                </li>
                <li>
    ...
    <div class="rightside">
        ...
        <table class="rwd-table ">
            ...
            <tr>
                ...
                <td data-th="狀態">待審</td>
                <td data-th="編輯"><button type="button" class="btn btn-primary" id="btn_edit">編輯</button>
                    <button type="button" class="btn btn-danger" id="btn_delete">刪除</button></td>
    ...
    <script src="productstyle/member.js"></script>
