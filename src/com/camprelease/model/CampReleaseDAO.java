...
public class CampReleaseDAO implements CampReleaseDAO_interface {
	...
	private static final String INSERT_STMT = 
			"INSERT INTO campsite2 (CAMP_NAME, MEMBER_ID, LOCATION, LATITUDE, LONGTITUDE, CAMP_DESCRIPTION, CAMP_PRICE, LISTED_TIME, PICTURE1, PICTURE2, PICTURE3, PICTURE4, PICTURE5) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	private static final String GET_ALL_STMT = 
			"SELECT CAMP_ID, MEMBER_ID, CAMP_NAME, MEMBER_ID, LOCATION, LATITUDE, LONGTITUDE, CAMP_DESCRIPTION, CAMP_PRICE, LISTED_TIME, PICTURE1, PICTURE2, PICTURE3, PICTURE4, PICTURE5, MEMBER_ID FROM campsite2 order by CAMP_ID";
	private static final String GET_ONE_STMT = 
			"SELECT CAMP_ID, MEMBER_ID, CAMP_NAME, LOCATION, LATITUDE, LONGTITUDE, CAMP_DESCRIPTION, CAMP_PRICE, LISTED_TIME, PICTURE1, PICTURE2, PICTURE3, PICTURE4, PICTURE5 FROM campsite2 where CAMP_ID = ?";
	private static final String DELETE = 
			"DELETE FROM campsite2 where CAMP_ID = ?";
	private static final String UPDATE = 
			"UPDATE campsite2 set CAMP_NAME=?, MEMBER_ID=?, LOCATION=?, LATITUDE=?, LONGTITUDE=?, CAMP_DESCRIPTION=?, CAMP_PRICE=?, LISTED_TIME=?,  PICTURE1=?, PICTURE2=?, PICTURE3=?, PICTURE4=?, PICTURE5=? where CAMP_ID = ?";
