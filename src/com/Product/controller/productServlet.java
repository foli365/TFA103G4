...
//			 System.out.println("in1="+in1);
		...
		/***************************2.開始修改資料*****************************************/
			ProductService proSvc = new ProductService();
			productVO = proSvc.updateProduct(productno, pname, psort, price, inventory, admin_id, situation, descript, picture1, picture2, picture3);
	...
	/***************************2.開始新增資料*****************************************/
			ProductService proSvc = new ProductService();
			productVO = proSvc.addProduct(pname, psort, price, inventory, admin_id, situation, descript, picture1, picture2, picture3);				 
